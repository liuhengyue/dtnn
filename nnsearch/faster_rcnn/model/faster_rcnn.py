...
from nnsearch.faster_rcnn.model.utils.bbox_tools import loc2bbox
from nnsearch.faster_rcnn.model.utils.nms import non_maximum_suppression

from torch import nn
from nnsearch.faster_rcnn.data.dataset import preprocess
...
class FasterRCNN(nn.Module):
    ...
    def set_gate_control( self, u ):
      self.extractor.set_gate_control( u )
      self.head.classifier.set_gate_control( u )
